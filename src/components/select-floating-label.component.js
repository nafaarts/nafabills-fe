...
const SelectFloatingLabel = ({ label, data, bind }) => {
    ...
    return (
        <div className="relative z-0 mb-6 w-full group">
            <select className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none  dark:focus:border-orange-500 focus:outline-none focus:ring-0 focus:border-orange-600 peer" placeholder="" onChange={changeValue}>
